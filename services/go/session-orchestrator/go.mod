// session-orchestrator - Call state machine: turn-taking, barge-in and timeouts. The latency-critical hot path.
//
...
module github.com/callscreen/callscreen-platform/services/go/session-orchestrator
