// Command server is the entrypoint for the session-orchestrator service.
//
// Call state machine: turn-taking, barge-in and timeouts. The latency-critical hot path.
//
