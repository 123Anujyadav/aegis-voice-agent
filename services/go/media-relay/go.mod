// media-relay - RTP/SRTP to internal audio bus relay, jitter buffer, transcode and VAD frontend.
//
...
module github.com/callscreen/callscreen-platform/services/go/media-relay
