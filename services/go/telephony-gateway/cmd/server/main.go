// Command server is the entrypoint for the telephony-gateway service.
//
// SIP/SIPS signalling, carrier trunk management, DID pool and call admission control.
//
