"""Configuration for the transcript-service service."""
...
class TranscriptServiceConfig(ServiceConfig):
    """Settings for transcript-service.
    ...
    Variables are read with the `CS_TRANSCRIPT_SERVICE_` prefix, matching the
    naming convention in Phase 1 §5.
    """

    model_config = SettingsConfigDict(
        env_prefix="CS_TRANSCRIPT_SERVICE_",
        env_file=None,
